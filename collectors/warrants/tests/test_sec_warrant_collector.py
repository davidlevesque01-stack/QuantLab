...
def test_collect_ticker_warrants_returns_cik_not_found_when_unresolved():
    result = collect_ticker_warrants(
        "ZZZZ",
        TICKER_CIK_MAP,
...
def test_collect_ticker_warrants_returns_no_facts_when_untagged():
    with patch(
        "collectors.warrants.src.sec_warrant_collector.fetch_company_facts",
...
def test_collect_ticker_warrants_persists_extracted_facts():
    company_facts = {
        "facts": {
            "us-gaap": {
    ...
    with patch(
        ...
        "collectors.warrants.src.sec_warrant_collector.persist_sec_warrant_xbrl_facts",
